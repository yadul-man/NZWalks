...
namespace NZWalks.API.Repositories
{
    public class SQLWalkRepository : IWalkRepository
    {
        ...
        {
            // Broken down dbContext.Walks.Include("Difficulty").Include("Region").ToListAsync() to perform operations (pagination or filtering) on the result
            ...
            // Pagination
            var skipResults = (pageNumber - 1) * pageSize; // Count of items to be skipped
